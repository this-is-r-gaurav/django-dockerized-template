            ...
            strengthDisplay: function(b, c) {
                ...
                c && a.extend(d, c), b.bind("keyup", function() {
                    var b = a(this).val(),
                        ...
                        h = d.bad;
                    0 === e.length && (e = a("<span></span>"), e.addClass("strength-meter").appendTo(c)), b ? e.show() : e.hide(), 1 === f ? h = d.weak : 2 === f ? (g.color = "#fa755a", h = d.good) : f >= 3 && (g.color = "#3ecf8e", h = d.strong), e.css(g).text(h)
                })
            }
        });
